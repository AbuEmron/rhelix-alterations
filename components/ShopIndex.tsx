 ...
 */
export default function ShopIndex({ page }: { page: number }) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pb-16 pt-28 md:px-8 md:pt-36">
      <Reveal>
        <p className="eyebrow">De volledige collectie</p>
      </Reveal>
      <Reveal delay={100}>
        <h1 className="headline mt-4 text-5xl md:text-7xl">Shop</h1>
      </Reveal>
      <Reveal delay={200}>
      ...
      {totalPages > 1 && (
        <nav aria-label="Paginering" className="mt-16 flex items-center justify-center gap-2">
